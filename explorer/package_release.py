...
FILES = ("usdb-explorer", "usdb-public", "usdb_public.py", "public_setup.py", "public_config.py", "public_checks.py", "ingress_checks.py", "faucet_config.py", "faucet_cli.py", "config.example.json",
